...
class FaceMeshDetector:
        ...
        try:
            ...
            if self.results.multi_face_landmarks:
                ...
                for faceLms in self.results.multi_face_landmarks:
                    x_min, x_max, y_min, y_max = self.draw_rectangle(frame, faceLms)
                    list_coord.append((x_min, x_max, y_min, y_max))
    ...
    def draw_rectangle(self, frame: np.ndarray, faceLms: mp.solutions.face_mesh.NamedTuple):
        """
